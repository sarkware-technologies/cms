...
const BooleanFieldConfig = (props, ref) => {

    const [state, setState] = useState({
        required: ('required' in props.config) ? props.config.required : false,
        default: ('default' in props.config) ? props.config.default : false                
    });
    ...
    const handleDefaultChange = (_e) => {
        setState((prevState) => ({...prevState, default: _e.target.value === 'true'}));
    }  
    ...
    return (
        <div className="pharmarack-cms-field-configure-view">
            ...
            <div className="pharmarack-cms-field-configure-row">
                ...
                <div className="config">
                    <ul className="horizontal">
                        <li><label><input type="radio" value={true} name="default_option" checked={state.default} onChange={handleDefaultChange} /> TRUE</label></li>
                        <li><label><input type="radio" value={false} name="default_option" checked={!state.default} onChange={handleDefaultChange} /> FALSE</label></li>
                    </ul>                    
                </div>
            </div>            
...
export default forwardRef(BooleanFieldConfig);